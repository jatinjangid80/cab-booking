            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left p-5 flex items-center justify-between gap-4 font-bold text-[#111827] hover:text-[#E53935] transition-colors cursor-pointer"
                >
                  <span className="flex items-center gap-3 text-sm sm:text-base">
                    <HelpCircle className="w-5 h-5 text-[#E53935] shrink-0" />
                    {faq.question}
                  </span>
                  <div className={`p-1 rounded-full bg-white text-slate-500 transition-transform duration-200 shadow-2xs ${isOpen ? 'rotate-180 bg-red-50 text-[#E53935]' : ''}`}>
