      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {onBackToHome && (
          <div className="mb-8">
            <button
              ...
              className="inline-flex items-center gap-2 text-slate-500 hover:text-[#E53935] font-bold transition-colors cursor-pointer group"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-3">
                  <div className="flex flex-col">
                    ...
                    <div className="text-lg font-black text-[#111827] leading-none mt-0.5">
                      ₹{vehicle.baseFare} <span className="text-[11px] font-bold text-slate-500">+ ₹{vehicle.pricePerKm}/km</span>
                    </div>
                    <div className="text-[9px] text-slate-400 font-medium mt-1">*Excludes Toll & Parking</div>
                  </div>
        ...
        {limit && filteredVehicles.length > limit && onViewAll && (
          <div className="mt-12 text-center">
            <button
              onClick={onViewAll}
              className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition-colors cursor-pointer group"
            >
              View All Fleet
